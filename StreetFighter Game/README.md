...
Overall, it was definitely a fun game to create and it had over 4000 lines of code! As I had mentioned earlier on, I was most proud of the fact that I not only created a game that was similar to something I had played before, but I also found a creative way (that involved Timers, arrays, jump indexes and quadratic equations!) to recreate the idea of a player jumping.
